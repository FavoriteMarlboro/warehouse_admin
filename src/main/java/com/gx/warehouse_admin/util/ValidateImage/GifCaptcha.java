package com.gx.warehouse_admin.util.ValidateImage;



import com.gx.warehouse_admin.util.ValidateImage.util.GifEncoder;
import com.gx.warehouse_admin.util.ValidateImage.util.Streams;

import java.awt.*;
import java.awt.image.BufferedImage;
import java.io.OutputStream;

import static com.gx.warehouse_admin.util.ValidateImage.util.Randoms.alpha;
import static com.gx.warehouse_admin.util.ValidateImage.util.Randoms.num;
